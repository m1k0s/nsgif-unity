...
typedef struct gif_frame {
	...
	*/
  	size_t frame_pointer;		/**< offset (in bytes) to the GIF frame data */
...
typedef struct gif_animation {
	...
	/**	Internal members are listed below
	*/
	size_t buffer_position;			/**< current index into GIF data */
	size_t buffer_size;			/**< total number of bytes of GIF data available */
